...
echo "Optional — git hooks (pre-commit secret scan + public doc check):"
echo "  bash scripts/install-git-hooks.sh"
echo "  # Guide: docs/git-hooks.md"
echo "Optional — auto PR after git push:"
echo "  bash scripts/git-ship.sh pr  # after push; or git-pr-complete.sh"
