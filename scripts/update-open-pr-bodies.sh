#!/usr/bin/env bash
# Rewrite open PR bodies (currently PR #1 phase3 milestone).
...
* **Branch:** phase3 · **WBS:** 3.5, 3.6 · **After:** Phase 2 → main (step 2/3: Sheets + polling) #2 (merged)
* **Final target:** main
...
* **ブランチ:** phase3 · **WBS:** 3.5, 3.6 · **前提:** Phase 2 → main (step 2/3: Sheets + polling) #2 マージ済み
* **マージ先:** main
"""
